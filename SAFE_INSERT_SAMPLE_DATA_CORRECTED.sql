-- ============================================================================
-- БЕЗОПАСНАЯ ВСТАВКА ТЕСТОВЫХ ДАННЫХ (ИСПРАВЛЕННАЯ ВЕРСИЯ)
...
-- ============================================================================
-- ТЕСТОВІ КОРИСТУВАЧІ (ИСПРАВЛЕНО: используем нижний регистр для subscription_type)
-- ============================================================================
...
-- Получаем ID пользователей и книг для создания тестовых аренд
...
SELECT 
    ...
    'Sample data inserted safely with correct subscription types!' as message;