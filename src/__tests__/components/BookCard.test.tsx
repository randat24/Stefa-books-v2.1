...
const mockBook: Book = {
  ...
  short: 'This is a test book description',
  price: 299,
  available: true,
};
  ...
  describe('Visual states', () => {
    ...
    it('should handle long descriptions gracefully', () => {
      const bookWithLongDescription: Book = {
        ...mockBook,
        short: 'This is a very long book description that should be truncated properly to maintain consistent card heights and good visual hierarchy',
      };

      render(<BookCard book={bookWithLongDescription} />);

      const description = screen.getByText(bookWithLongDescription.short);
